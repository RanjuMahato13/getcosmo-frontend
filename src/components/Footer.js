            ...
            <div className="col-5">
              <div className="footer-top-data d-flex gap-30 align-items-center">
                <h2 className="mb-0 text-white">
                  Sign Up for More Notifications
                </h2>
              </div>
            </div>
            <div className="col-7">
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <Link to="/suggestion" className="text-white py-2 mb-3">
                  Suggestion
                </Link>
                ...
                <a
                  href="Phone: 9805899990 / 9876543210"
                  className="mt-4 d-block mb-3 text-white"
                >
                  Phone: 9805899990 / 9876543210
                </a>
                <a
                  href="Hours:10:00am - 5:00pm, Sunday-Friday"
                  className="mt-4 d-block mb-3 text-white"
                >
            ...
            <div className="col-3">
              ...
              <div>
                <div className="footer-links d-flex flex-column">
                  ...
                  <Link className="text-white py-2 mb-1" to="/contactus">
                    Contact Us
                  </Link>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by Getcosmo Product
              </p>
            </div>
          </div>
        </div>
